using static System.Console;  // Simplify console output

// See https://aka.ms/new-console-template for more information
WriteLine("Hello, World!");
WriteLine("Joshua Ramos");
...
{
    { "Basketball", "Football", "Baseball", "Delta" },
    { "Kevin", "Josh", "Charlie", "Doug" },
...
{
    new[] { "Basketball", "Football", "Baseball" },
    new[] { "Josh", "Ben", "Brandon", "Doug" },
    new[] { "Aardvark", "Bear" }
};
